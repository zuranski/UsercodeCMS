...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('UsercodeCMS/DisplacedJetMCProd/python/LongLivedChi0ToMuQQ_MSquark_700_MChi_500_TuneZ2Star_8TeV_pythia6_cff.py nevts:10'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('LongLivedChi0ToMuQQ_MSquark_700_MChi_500_TuneZ2Star_8TeV_pythia6_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_RECO_PU.root'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        pythiaParameters = cms.vstring('MSTJ(22)=1             ! Decay all unstable particles', 
            ...
            'RVLAMP(2,1,1)=0.0000016   ! Set lambda Prime(2,1,1)', 
