...
process.djsignalfilterb = cms.EDFilter("XtoFFbarFilter",
    src = cms.InputTag("genParticles"),
...
process.p_DJ = cms.Path(process.empty+process.djsignalfilterb+process.djpileupsummary+process.djgenevent+process.djtriggers+process.djeventfilters+process.djevent+process.djdisplacedjets+process.djTree)
...
process.TFileService = cms.Service("TFileService",
    ...
    fileName = cms.string('ntupleb.root')
)
