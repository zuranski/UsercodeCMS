...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2011B/HT/RECO/19Nov2011-v1/10001/B2E314BC-4746-E111-9BC1-00261894390A.root')
)
...
process.patDefaultSequence = cms.Sequence(process.kt6PFJets+process.patJetCorrFactors+process.jetTracksAssociatorAtVertex+process.btaggingAOD+process.patJetCharge+process.patJets+process.makePatMETs+process.patCandidateSummary+process.selectedPatJets+process.selectedPatCandidateSummary+process.countPatLeptons+process.countPatJets)
...
process.p_DJ = cms.Path(process.empty+process.djtriggerselector+process.djtriggers+process.djeventfilters+process.djevent+process.djdisplacedjets+process.djTree)
...
process.TFileService = cms.Service("TFileService",
    ...
    fileName = cms.string('ntupled.root')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('FT_R_44_V11::All')
)
