...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/Fall11/QCD_Pt-170to300_TuneZ2_7TeV_pythia6/AODSIM/PU_S6_START42_V14B-v1/0000/FCD9F545-A506-E111-AA8F-003048D477BA.root')
)
...
process.p_DJ = cms.Path(process.empty+process.djpileupsummary+process.djgenevent+process.djtriggers+process.djeventfilters+process.djevent+process.djdisplacedjets+process.djTree)
...
process.TFileService = cms.Service("TFileService",
    ...
    fileName = cms.string('ntupleq.root')
)
