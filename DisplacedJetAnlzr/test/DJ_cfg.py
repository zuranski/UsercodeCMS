...
process.setName_("DJ")
from UsercodeCMS.DisplacedJetAnlzr.DJ_options_cff import options
options = options()
...
from UsercodeCMS.DisplacedJetAnlzr.DJ_nTuple_cfi import DJ
import UsercodeCMS.DisplacedJetAnlzr.DJ_ProcessAdjustments_cfi as adjust
